...
import { JhipsterApplicationSharedModule, UserRouteAccessService } from './shared';
...
import { JhipsterApplicationAdminModule } from './admin/admin.module';
...
@NgModule({
    imports: [
        ...
        JhipsterApplicationAdminModule,
